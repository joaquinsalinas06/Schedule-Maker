...
export const Help = () => {
  ...
  return (
    <div className="p-10 text-white w-3/4 mx-auto">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-4">{t('helpInitialSetupTitle')}</h2>
        <p className="text-lg">{t('helpInitialSetupContent')}</p>
      </section>

      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-4">{t('helpCourseInputTitle')}</h2>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-4">{t('helpShiftSetupTitle')}</h2>
        <ul className="list-disc list-inside text-lg ml-5">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-4">{t('helpExportImportTitle')}</h2>
        <p className="text-lg">{t('helpExportImportContent')}</p>
      </section>

      <section>
        <h2 className="text-2xl font-semibold mb-4">{t('helpGenerateScheduleTitle')}</h2>
